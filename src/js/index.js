/*
    ...
    - objetivo 2 - quando clicar no botão de troca de tema, caso o body já tenha a classe modo-escuro, remover a classe pra mudar pro modo claro e mudar a imagem pro sol
       -passo 6-verificar se o body já tem a classe do modo-escuro do body
...
//- passo 1 - pegar no JS o elemento HTML correspondente ao botão de troca de tema
const botaoAletrarTema = document.getElementById("botao-alterar-tema");

//- passo 2 - dar um jeito de pegar no JS o elemento HTML corresponde ao body
const body = document.querySelector("body");

const imagemBotãoTrocaDeTema = document.querySelector(".imagem-botao")

//- passo 3 - dar um jeito de identificar o clique do usuário no botão de troca de tema
botaoAletrarTema.addEventListener("click", () => {

    //- passo 6-7 - remover a classe do modo-escuro do body
    ...
    if (modoEscuroEstaAtivo) {
        //- passo 8 - trocar a imagem do botão de alterar tema pra sol
    imagemBotãoTrocaDeTema.setAttribute("src", "./src/imagens/sun.png")

    } else {
        //- passo 5 - trocar a imagem do botão de alterar tema pra lua
        imagemBotãoTrocaDeTema.setAttribute("src", "./src/imagens/moon.png")
